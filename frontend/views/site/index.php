                        ...
                        <div class="probootstrap-image-text-block probootstrap-cause">
                            ...
                            <div class="probootstrap-cause-inner">
                                ...
                                <div class="progress">
                                    ...
                                    <a href="/view?id=<?=$application->id; ?>"><button class="btn btn1_2 first">пожертвовать</button></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach;?>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="item">
                            ...
                            <div class="info">
                                ...
                                <a href="/newsViews?id=<?=$new->id; ?>"><h5><?=substr($new->title_ru, 0, 100); ?>...</h5></a>
                                <p><?=substr($new->text_ru, 0, 600);?>...</p>
