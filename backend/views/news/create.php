...
<!--                                </li>-->
                            ...
                            <div class="tab-content mb-4" id="border-tabsContent">
                                <form style="margin-top: 25px" action="/news/create" method="post" id="news-form"  enctype="multipart/form-data">
                                    <div class="tab-pane fade show active" id="border-home" role="tabpanel" aria-labelledby="border-home-tab">
                                            <div class="form-group mb-4">
                                                ...
                                                <input required type="text" name="title_ru" class="form-control" id="inputAddress">
                                            </div>
                                            <div class="form-group mb-4">
                                        ...
                                        <input id="text_value" type="text" name="text_ru" style="display: none">
                                    </div>
